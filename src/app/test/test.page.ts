...
export class TestPage implements OnInit {
  questions: any[] = [
    ...
    },
    {
      ...
      image: 'assets/road_sign.png',
      options: ['A. The drawn vehicle must be a semi-trailer.', 'B. The vehicle must not exceed a speed of 40km/h.', 'C. The drawn vehicle must be a traler.'],
      correctAnswer: 'C. Do not enter',
      selectedAnswer: '',
    },
    {
